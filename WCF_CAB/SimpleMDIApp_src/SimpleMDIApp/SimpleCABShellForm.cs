...
{
    public partial class SimpleCABShellForm : Form
    {
        private WorkItem m_workItem;
        private IWorkItemTypeCatalogService m_workItemTypeCatalog;
        private IWorkspace m_mdiWorkspace;

        public SimpleCABShellForm()
        {
            InitializeComponent();
        }

       [InjectionConstructor]
        public SimpleCABShellForm(WorkItem workItem, IWorkItemTypeCatalogService workItemTypeCatalog) : this()
        {
